			...
			<!-- form row -->
					...
					<div class="col-lg-4 form">
						...
						<div style="text-align:center">
							...
							<div class="row"  >
								...
								<div class="col" style="">
									<p class="by-clicking-text"><img width="80" height="30" src="<?php echo $banner_group['bottom_image']['url'];?>" alt=""><br class="mobile-text-image" style="display:none;"> <?php echo $banner_group['bottom_text'];?></p>
								</div>
							</div>
						</div>
						</form>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-4 img-arrow-col">
							<img class="img-arrow" src="<?php  echo  $banner_group['arrow-img']['url'];?>" alt="">
						</div>
						<div class="col-lg-4">
				...
				<div class="row">
					<div class="col-lg-4 box">
						<img src="<?php  echo  $banner_group['services-img-1']['url'];?>" alt="">
					...
					<div class="col-lg-4 box">
						<img src="<?php  echo  $banner_group['services-img-2']['url'];?>" alt="">
					...
					<div class="col-lg-4 box">
					<img src="<?php  echo  $banner_group['services-img-3']['url'];?>" alt="">
					<div class="d-flex p-1" style="background-color:#2ab4c5; border-radius:0;">
